 ...
 *
 * <p>This is a copy of telemetry-service's {@code security/SsrfAddressPolicy}, kept
 ...
 * precedent — and a divergence between the two would mean tenant-service accepting an address that
 * message-service later refuses, which surfaces as mail that silently falls back to the system
