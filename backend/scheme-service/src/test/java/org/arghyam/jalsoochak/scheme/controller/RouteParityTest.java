...
import org.arghyam.jalsoochak.scheme.SchemeServiceApplication;
...
class RouteParityTest {
    ...
    private static final String SERVICE_PACKAGE = "org.arghyam.jalsoochak.scheme";

    private static final List<String> SERVED_ROUTES = List.of(
            // Scheme queries
            "GET /api/v1/scheme/schemes",
            "GET /api/v1/scheme/schemes/yesterday-final-readings",
            "GET /api/v1/scheme/schemes/mappings",
            "GET /api/v1/scheme/schemes/counts/by-status",
            "GET /api/v1/public/schemes/{schemeId}",
            // Scheme status
            "GET /api/v1/scheme/schemes/{schemeId}/statuses",
            "PATCH /api/v1/scheme/schemes/{schemeId}/status",
    ...
    private static List<String> servedRoutes() {
        ...
        return provider.findCandidateComponents(SERVICE_PACKAGE).stream()
                ...
                .filter(type -> codeSource(type).equals(codeSource(SchemeServiceApplication.class)))
