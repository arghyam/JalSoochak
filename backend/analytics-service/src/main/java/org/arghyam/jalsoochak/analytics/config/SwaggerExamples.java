...
public final class SwaggerExamples {
    ...
    public static final String CRITICAL_SCHEMES_USER_COUNT_SUCCESS = """
            {
              "success": true,
              "data": {
                "criticalSchemeCount": 2,
                "list": false,
                "page": null,
                "limit": null,
                "schemes": null
    ...
    public static final String CRITICAL_SCHEMES_USER_LIST_SUCCESS = """
            {
              "success": true,
              "data": {
                "criticalSchemeCount": 2,
    ...
    public static final String CONTINUOUS_SCHEMES_USER_COUNT_SUCCESS = """
            {
              "success": true,
              "data": {
                "continuousSchemeCount": 5,
    ...
    public static final String CONTINUOUS_SCHEMES_USER_LIST_SUCCESS = """
            {
              "success": true,
              "data": {
                "continuousSchemeCount": 2,
