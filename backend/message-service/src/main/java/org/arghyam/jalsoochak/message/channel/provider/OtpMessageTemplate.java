 ...
 * is deliberate, for the reason {@link org.arghyam.jalsoochak.message.security.ProviderEndpointPolicy
 * ProviderEndpointPolicy} re-checks an SMTP host: a row can
